...
export const ActionLog: React.FC<Props> = ({ logs }) => {
  ...
  return (
    <div className="bg-black border-t border-border h-48 p-4 flex flex-col">
      <div className="flex items-center gap-2 mb-2 text-gray-400">
        <Terminal size={16} />
        <h3 className="font-mono text-sm tracking-widest uppercase">Audit Log</h3>
      </div>
      ...
      <div className="flex-1 overflow-y-auto font-mono text-xs space-y-1 custom-scrollbar">
        ...
        {logs.length === 0 && (
          <div className="text-gray-600 italic">No actions recorded. System standing by.</div>
        )}
        <div ref={bottomRef} />
      </div>
    </div>
